...
_$CatDetailResponseImpl _$$CatDetailResponseImplFromJson(
        Map<String, dynamic> json) =>
    _$CatDetailResponseImpl(
...
Map<String, dynamic> _$$CatDetailResponseImplToJson(
        _$CatDetailResponseImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'url': instance.url,
